  ...
  return (
    <Screen>
      <ScrollView contentContainerClassName="gap-4 p-6">
        <View className="h-14 w-14 items-center justify-center rounded-2xl bg-wash-slate">
          <Ionicons name="construct-outline" size={26} color={colors.slate} />
        </View>
        <Text className="font-ui-black text-2xl text-ink">Almost there</Text>
        ...
        <View className="rounded-2xl bg-bezel p-4">
          <Text className="font-mono text-xs leading-5 text-paper">
